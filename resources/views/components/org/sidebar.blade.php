...
<div class="flex h-full flex-col">
    ...
    <nav class="flex-1 overflow-y-auto px-3 py-2 scrollbar-thin">
        ...
        <a href="{{ route('org.contacts.index') }}" class="cp-sidebar-link {{ request()->routeIs('org.contacts.*') ? 'cp-sidebar-link-active' : '' }}">
            <svg class="h-4 w-4 shrink-0 opacity-70" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M16 7a4 4 0 11-8 0 4 4 0 018 0zM12 14a7 7 0 00-7 7h14a7 7 0 00-7-7z"/></svg>
            Contacts
        </a>
        <a href="{{ route('org.campaigns.index') }}" class="cp-sidebar-link {{ request()->routeIs('org.campaigns.*') ? 'cp-sidebar-link-active' : '' }}">
